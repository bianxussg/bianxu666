<template>
  <div class="base2">
    ...
    <div class="control">
      ...
      <div class="inputContain">
        <span class="des">高h2:</span>
        <input  type="number" class="input1" v-model="h2">
      </div>
...
<script type='text/ecmascript-6'>
  ...
  export default {
    ...
    created(){
      ...
      this.$watch('h2',this.debounce(()=>{
        this.$refs.owl.hidden()
      },300))
    },
    computed:{
      c:function () {
        return Math.sqrt(Math.pow((this.a-this.b)/2,2)+Math.pow(this.h1,2))
      },
      h1:function () {
        return this.h-this.h2
      }
